...
### Результаты:
В файле PJ-04.ipynb приведены графики и код решения поставленных задач, полученные в результате обработки данных из предоставленного файла data.zip.

:arrow_up:[к оглавлению](README.md#оглавление)


### Выводы:
Выводы по заданию приведены в файле PJ-04.ipynb.
